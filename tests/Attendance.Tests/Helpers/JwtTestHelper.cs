...
/// Uses the same constants as Attendance.API/appsettings.json to simulate tokens
...
public static class JwtTestHelper
{
    ...
    /// <summary>Creates a Docente JWT (most common write permission).</summary>
    public static string DocenteToken() => CreateToken("Docente");

    /// <summary>Creates a Direccion JWT (can also read history).</summary>
    public static string DireccionToken() => CreateToken("Direccion");

    /// <summary>Creates a Secretaria JWT (no access to any attendance endpoint).</summary>
    public static string SecretariaToken() => CreateToken("Secretaria");
}
