    ...
    public partial class InitialAttendance : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    attendance_record_id = table.Column<string>(type: "character varying(26)", maxLength: 26, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_attendance_records", x => x.attendance_record_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    incident_id = table.Column<string>(type: "character varying(26)", maxLength: 26, nullable: false),
                    student_id = table.Column<string>(type: "character varying(26)", maxLength: 26, nullable: false),
