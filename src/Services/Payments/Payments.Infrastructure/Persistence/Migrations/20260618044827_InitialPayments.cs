    ...
    public partial class InitialPayments : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    obligation_id = table.Column<string>(type: "character varying(26)", maxLength: 26, nullable: false),
                    ...
                    payment_id = table.Column<string>(type: "character varying(26)", maxLength: 26, nullable: true),
                    ...
                    payment_confirmed_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: true),
                    created_at = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_obligations", x => x.obligation_id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "ix_obligations_student_id",
                table: "obligations",
                column: "student_id");
        }
