...
/// apply inside container: docker exec -i cc-payments-db psql -U postgres -d payments_db &lt; migration.sql
/// </summary>
public sealed class PaymentsDesignTimeDbContextFactory : IDesignTimeDbContextFactory<PaymentsDbContext>
{
    public PaymentsDbContext CreateDbContext(string[] args)
    {
        var opts = new DbContextOptionsBuilder<PaymentsDbContext>()
            .UseNpgsql("Host=localhost;Port=5432;Database=payments_db;Username=postgres;Password=postgres")
            .Options;
